                    ...
                    return (
                        <div className="card home-card" key={item._id}>
                            ...
                            <div className="card-image-new">
                                ...
                                {/* --- NAYA CODE (Icon Buttons) --- */}
                                <div className="card-image-links">
                                    {item.githubLink && (
                                        <a href={item.githubLink} target="_blank" rel="noopener noreferrer" className="image-link-btn">
                                            <i className="material-icons">code</i>
                                        </a>
                                    )}
                                    {item.livePreviewLink && (
                                        <a href={item.livePreviewLink} target="_blank" rel="noopener noreferrer" className="image-link-btn">
