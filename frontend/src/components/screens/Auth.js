    ...
    const uploadSignUpField = () => {
        ...
        .then(data => {
            if (data.error) {
                ...
                setIsRightPanelActive(false); // Sign in panel par waapis slide karo
            }
        })
        .catch(err => console.log(err));
    };
        ...
        <div className="auth-page-container">
            <div className={`auth-container ${isRightPanelActive ? "right-panel-active" : ""}`}>
                ...
                <div className="form-container signup-container">
                    <form className="auth-form" onSubmit={(e) => { e.preventDefault(); PostSignUpData(); }}>
                        ...
                        <input type="number" placeholder="Semester (e.g., 1, 2)" value={signUpSemester} onChange={e => setSignUpSemester(e.target.value)} />

                        <div className="file-field input-field" style={{width: "100%", marginTop: "10px"}}>
                            <div className="btn">
                ...
                <div className="form-container signin-container">
                    <form className="auth-form" onSubmit={(e) => { e.preventDefault(); PostSignInData(); }}>
                        <h2>Login</h2>
